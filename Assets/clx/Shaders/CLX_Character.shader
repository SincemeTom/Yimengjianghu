	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i) : SV_Target
			{
				...
				//fixed4 texBase = tex2D(_MainTex, i.uv);
				...
				int3 isNegative =/* int3(lessThan(normalVec, float3(0.0,0.0,0.0)))*/ int3(1,1,1);
				...
				return half4 (GILighting.xyz * DiffuseColor, texBase.w);
			}
